		  ...
		  <div class="card z-depth-0 bordered" id="appInterfaceAccordian">
			...
			<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionView">
			  <div id="appInterfaceContainer" class="card-body">
				...
				<div id="numOfPlayersContainer" class="form-label-group">
					<label for="numOfPlayers">Players on field?</label>
					<select class="form-control form-sm" id="numOfPlayers" name="numOfPlayers" required>
						<option value=11 selected disabled>Select Number</option>
				...
				<div id="field" class="field col-xs-12"> 		
					<div class="grid-container">
					  <div id="fieldPlayer1" class="fieldPlayer rounded-circle" data-idJersey="">#</div>
					  <div id="fieldPlayer2" class="fieldPlayer rounded-circle" data-idJersey="">#</div>  
					  <div id="fieldPlayer3" class="fieldPlayer rounded-circle" data-idJersey="">#</div>
					  <div id="fieldPlayer4" class="fieldPlayer rounded-circle" data-idJersey="">#</div>
					  <div id="fieldPlayer5" class="fieldPlayer rounded-circle" data-idJersey="">#</div>
					  <div id="fieldPlayer6" class="fieldPlayer rounded-circle" data-idJersey="">#</div>
					  <div id="fieldPlayer7" class="fieldPlayer rounded-circle" data-idJersey="">#</div>  
					  <div id="fieldPlayer8" class="fieldPlayer rounded-circle" data-idJersey="">#</div>
					  <div id="fieldPlayer9" class="fieldPlayer rounded-circle" data-idJersey="">#</div>
					  <div id="fieldPlayer10" class="fieldPlayer rounded-circle" data-idJersey="">#</div>
